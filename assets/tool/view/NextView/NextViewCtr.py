...
class NextViewCtr(object):
	"""docstring for NextViewCtr"""
	def __init__(self, parent, params = {}):
		super(NextViewCtr, self).__init__();
		self._className_ = NextViewCtr.__name__;
	...
	def initUI(self, parent, params):
		# 创建视图UI类
		self.__ui = NextViewUI(parent, curPath = self._curPath, viewCtr = self, params = params);
		self.__ui.initView();
